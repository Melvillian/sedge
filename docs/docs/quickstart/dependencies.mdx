...
With the above command, Sedge will install the required dependencies using predefined [scripts](https://github.com/Melvillian/sedge/tree/main/templates/setup/linux/docker).
